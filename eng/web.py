...
st.write("")
st.write("##### Participants: <span style='font-weight:normal;'>André Neiva, Daniel Furtado, Francisco Falcão, Rita.</span>", unsafe_allow_html=True)
...
The meeting started promptly at 11:35 AM, with the presence of André Neiva, Rita, Daniel Furtado, and Francisco Falcão. 
...
st.write("###### 🔸 Can trainees opt out of engagement analysis? <span style='font-weight:normal;'>(Rita)</span>", unsafe_allow_html=True)
...
st.write("###### 🔸 How can we prevent the presence of cameras from influencing trainee behavior? <span style='font-weight:normal;'>(Rita)</span>", unsafe_allow_html=True)
...
st.write(" &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - Some jokes and informal comments could be reduced to keep the meeting focused.")
...
data["person"] = data["person"].replace({0: "Rita", 1: "André Neiva", 2: "Francisco Falcão", 3: "Daniel Furtado"})
...
fig = px.line(
    ...
    line_dash="person",
    line_group="person",
    line_dash_map={"Global Mean": "dash", "André Neiva": "solid", "Daniel Furtado": "solid", "Francisco Falcão": "solid", "Rita": "solid"},
    hover_data=["Theme"],
    range_y=[0, 1]
)
